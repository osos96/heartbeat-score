...
const MEDALLION = [
  ...
  },
  {
    ...
    latency: '15-min refresh for ops KPIs',
    owner: 'Data Engineering + Analytics',
  },
  {
    tier: 'Gold', subtitle: 'Business Aggregates Layer', color: '#D97706',
    bg: '#FFFBEB', border: '#D9770640',
    desc: 'Business-ready aggregated tables powering dashboards and the HeartBeat score. Pre-computed at hub x day x hour grain. Optimised for fast BI queries.',
    tables: [
    ...
    <div style={{ padding: '100px 2rem 80px', maxWidth: 1340, margin: '0 auto' }}>
      ...
      <div style={{ marginTop: 40, display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16 }}>
        {[
          ...
          { title: 'Latency Design', body: 'Ops-facing KPIs refresh every 15 minutes via streaming. HeartBeat composite score is computed nightly as T-1 in Redshift. Executives see prior day score; ops managers see near-real-time hub data.' },
